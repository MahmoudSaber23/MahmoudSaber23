...
* Build strong foundations in **C# and .NET**
* Become comfortable with **ASP.NET Core**
* Understand how production backend systems work
* Build real-world backend projects
* Improve my software engineering practices
* Eventually become a professional **Backend Engineer**
